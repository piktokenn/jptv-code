...
.method public constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;)V
    ...
    invoke-direct {p0}, La/s/i$c;-><init>()V
...
# virtual methods
.method public onVolumeChanged(La/s/i;)V
    .locals 7
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;
    ...
    invoke-virtual {p1}, La/s/i;->c()I

    move-result v4

    invoke-virtual {p1}, La/s/i;->b()I

    move-result v5

    invoke-virtual {p1}, La/s/i;->a()I
