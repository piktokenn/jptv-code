...
.field private mRemoteUserInfo:La/s/b;
...
.field private mVolumeCallback:La/s/i$c;

.field public mVolumeProvider:La/s/i;

.field public mVolumeType:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;La/g0/d;Landroid/os/Bundle;)V
    .locals 3
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:La/s/i$c;
    ...
    invoke-direct {p2, p1, p3, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;La/g0/d;)V
...
.method public adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;

    if-eqz p2, :cond_1

    invoke-virtual {p2, p1}, La/s/i;->e(I)V
...
.method public getCurrentControllerInfo()La/s/b;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:La/s/b;
...
.method public setCurrentControllerInfo(La/s/b;)V
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:La/s/b;
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, La/s/i;->g(La/s/i$c;)V
...
.method public setPlaybackToRemote(La/s/i;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;

    invoke-virtual {v1}, La/s/i;->c()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;

    invoke-virtual {v1}, La/s/i;->b()I

    move-result v5

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:La/s/i;

    invoke-virtual {v1}, La/s/i;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:La/s/i$c;

    invoke-virtual {p1, v0}, La/s/i;->g(La/s/i$c;)V
...
.method public setVolumeTo(II)V
    ...
    invoke-virtual {p2, p1}, La/s/i;->f(I)V
