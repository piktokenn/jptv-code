.class public final Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;
.super Lcom/amplifyframework/storage/operation/StorageUploadInputStreamOperation;
.source ""
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation$UploadTransferListener;
    }
.end annotation
...
.method public constructor <init>(Lcom/amplifyframework/storage/s3/service/StorageService;Lcom/amplifyframework/storage/s3/CognitoAuthProvider;Lcom/amplifyframework/storage/s3/request/AWSS3StorageUploadRequest;Lcom/amplifyframework/core/Consumer;Lcom/amplifyframework/core/Consumer;Lcom/amplifyframework/core/Consumer;)V
    ...
    invoke-direct {p0, p3}, Lcom/amplifyframework/storage/operation/StorageUploadInputStreamOperation;-><init>(Ljava/lang/Object;)V

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast p1, Lcom/amplifyframework/storage/s3/service/StorageService;

    iput-object p1, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->storageService:Lcom/amplifyframework/storage/s3/service/StorageService;

    iput-object p2, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->cognitoAuthProvider:Lcom/amplifyframework/storage/s3/CognitoAuthProvider;

    invoke-virtual {p4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast p4, Lcom/amplifyframework/core/Consumer;

    iput-object p4, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onProgress:Lcom/amplifyframework/core/Consumer;

    invoke-virtual {p5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast p5, Lcom/amplifyframework/core/Consumer;

    iput-object p5, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onSuccess:Lcom/amplifyframework/core/Consumer;

    invoke-virtual {p6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast p6, Lcom/amplifyframework/core/Consumer;

    iput-object p6, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onError:Lcom/amplifyframework/core/Consumer;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->transferObserver:Lcom/amazonaws/mobileconnectors/s3/transferutility/TransferObserver;

    return-void
.end method

.method public static synthetic access$100(Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;)Lcom/amplifyframework/core/Consumer;
    .locals 0

    iget-object p0, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onSuccess:Lcom/amplifyframework/core/Consumer;

    return-object p0
.end method

.method public static synthetic access$200(Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;)Lcom/amplifyframework/core/Consumer;
    .locals 0

    iget-object p0, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onError:Lcom/amplifyframework/core/Consumer;

    return-object p0
.end method

.method public static synthetic access$300(Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;)Lcom/amplifyframework/core/Consumer;
    .locals 0

    iget-object p0, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onProgress:Lcom/amplifyframework/core/Consumer;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->transferObserver:Lcom/amazonaws/mobileconnectors/s3/transferutility/TransferObserver;

    if-eqz v0, :cond_0

    :try_start_0
    iget-object v1, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->storageService:Lcom/amplifyframework/storage/s3/service/StorageService;
    ...
    iget-object v1, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->onError:Lcom/amplifyframework/core/Consumer;

    new-instance v2, Lcom/amplifyframework/storage/StorageException;

    const-string v3, "Something went wrong while attempting to cancel your AWS S3 Storage upload input stream operation"
...
.method public pause()V
    ...
    const-string v3, "Something went wrong while attempting to pause your AWS S3 Storage upload input stream operation"
...
.method public resume()V
    ...
    const-string v3, "Something went wrong while attempting to resume your AWS S3 Storage upload input stream operation"
...
.method public start()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->cognitoAuthProvider:Lcom/amplifyframework/storage/s3/CognitoAuthProvider;
    ...
    :cond_2
    :try_start_1
    iget-object v3, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->storageService:Lcom/amplifyframework/storage/s3/service/StorageService;

    invoke-interface {v3, v0, v1, v2}, Lcom/amplifyframework/storage/s3/service/StorageService;->uploadInputStream(Ljava/lang/String;Ljava/io/InputStream;Lcom/amazonaws/services/s3/model/ObjectMetadata;)Lcom/amazonaws/mobileconnectors/s3/transferutility/TransferObserver;

    move-result-object v0

    iput-object v0, p0, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;->transferObserver:Lcom/amazonaws/mobileconnectors/s3/transferutility/TransferObserver;

    new-instance v1, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation$UploadTransferListener;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation$UploadTransferListener;-><init>(Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation;Lcom/amplifyframework/storage/s3/operation/AWSS3StorageUploadInputStreamOperation$1;)V
    ...
    const-string v3, "Issue uploading inputStream."
