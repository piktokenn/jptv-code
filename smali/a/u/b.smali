...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, La/u/b;->b:Ljava/io/File;

    iput-object p2, p0, La/u/b;->d:Ljava/io/File;

    invoke-static {p1}, La/u/b;->s(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, La/u/b;->c:J
    ...
    iput-object p2, p0, La/u/b;->e:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, La/u/b;->f:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, La/u/b;->g:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, La/u/b;->f:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, La/u/b;->i(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, La/u/b;->e:Ljava/io/RandomAccessFile;
...
.method public static n(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, La/u/b;->i(Ljava/io/Closeable;)V
...
.method public static s(Ljava/io/File;)J
    ...
    invoke-static {p0}, La/u/c;->c(Ljava/io/File;)J
...
.method public static t(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    .locals 7

    invoke-static {p0}, La/u/b;->q(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, La/u/b;->r(Ljava/io/File;)J
...
.method public static y(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
...
.method public close()V
    ...
    iget-object v0, p0, La/u/b;->g:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, La/u/b;->f:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, La/u/b;->e:Ljava/io/RandomAccessFile;
...
.method public final d()V
    ...
    iget-object v0, p0, La/u/b;->d:Ljava/io/File;

    new-instance v1, La/u/b$a;

    invoke-direct {v1, p0}, La/u/b$a;-><init>(La/u/b;)V
    ...
    iget-object v2, p0, La/u/b;->d:Ljava/io/File;
...
.method public v(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, La/u/b;->b:Ljava/io/File;
    ...
    iget-object v0, p0, La/u/b;->b:Ljava/io/File;

    iget-wide v2, p0, La/u/b;->c:J

    invoke-static {p1, v0, v2, v3, p2}, La/u/b;->t(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, La/u/b;->w(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-virtual {p0}, La/u/b;->x()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, La/u/b;->b:Ljava/io/File;

    invoke-static {v0}, La/u/b;->r(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, La/u/b;->c:J
    ...
    invoke-static/range {v2 .. v8}, La/u/b;->y(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public final w(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v0, La/u/b;->b:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, La/u/b;->q(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, La/u/b$b;

    iget-object v9, v0, La/u/b;->d:Ljava/io/File;

    invoke-direct {v8, v9, v7}, La/u/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, La/u/b;->s(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, La/u/b$b;->b:J
...
.method public final x()Ljava/util/List;
    ...
    iget-object v6, v1, La/u/b;->b:Ljava/io/File;
    ...
    invoke-virtual/range {p0 .. p0}, La/u/b;->d()V
    ...
    iget-object v0, v1, La/u/b;->b:Ljava/io/File;
    ...
    new-instance v11, La/u/b$b;

    iget-object v12, v1, La/u/b;->d:Ljava/io/File;

    invoke-direct {v11, v12, v0}, La/u/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, La/u/b;->n(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, La/u/b;->s(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, La/u/b$b;->b:J
    :try_end_1
    ...
    iget-wide v12, v11, La/u/b$b;->b:J
