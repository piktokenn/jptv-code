...
.field public static final f:La/i/r/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La/i/r/f<",
...
.field public s:Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;

.field public t:Z

.field public u:La/i/s/f0;
...
.field public y:La/i/s/r;

.field public final z:La/i/s/q;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, La/i/r/h;

    const/16 v1, 0xc

    invoke-direct {v0, v1}, La/i/r/h;-><init>(I)V

    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f:La/i/r/f;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0}, La/h/d/a;-><init>()V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:La/h/d/a;
    ...
    new-instance v0, La/i/s/q;

    invoke-direct {v0, p0}, La/i/s/q;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:La/i/s/q;

    const/4 v0, 0x0

    sget-object v1, La/h/c;->b:[I
    ...
    iput-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->w:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, La/i/s/x;->A(Landroid/view/View;)I
    ...
    invoke-static {p0, p1}, La/i/s/x;->y0(Landroid/view/View;I)V

    :cond_4
    return-void
.end method

.method public static L(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    .locals 5
...
.method public static P(Landroid/graphics/Rect;)V
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f:La/i/r/f;
...
.method public final B(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:La/h/d/a;

    invoke-virtual {v0, p1}, La/h/d/a;->j(Ljava/lang/Object;)Z
...
.method public final D(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;
    ...
    invoke-static {p1}, La/i/s/x;->z(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;

    invoke-virtual {v2}, La/i/s/f0;->j()I
    ...
    invoke-virtual {v2}, La/i/s/f0;->l()I
    ...
    invoke-virtual {v2}, La/i/s/f0;->k()I
    ...
    invoke-virtual {v2}, La/i/s/f0;->i()I
    ...
    invoke-static/range {v1 .. v6}, La/i/s/f;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method public final F(Landroid/view/View;II)V
    ...
    invoke-static {v1, p3}, La/i/s/f;->b(II)I
...
.method public final G(Landroid/view/View;Landroid/graphics/Rect;I)V
    .locals 8

    invoke-static {p1}, La/i/s/x;->U(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p1, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->W(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->W(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->V(Landroid/view/View;I)V
...
.method public H(Landroid/view/View;I)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->w(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    ...
    invoke-static {v9, v0}, La/i/s/x;->Z(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, La/i/s/x;->a0(Landroid/view/View;I)V
...
.method public final I(I)V
    ...
    invoke-static {v12, v2}, La/i/s/f;->b(II)I
    ...
    invoke-virtual {v0, v9, v4, v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->G(Landroid/view/View;Landroid/graphics/Rect;I)V
...
.method public final N()V
    ...
    invoke-virtual {v0}, La/h/d/a;->c()V
    ...
    iget-object v5, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:La/h/d/a;

    invoke-virtual {v5, v3}, La/h/d/a;->b(Ljava/lang/Object;)V
    ...
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:La/h/d/a;

    invoke-virtual {v7, v6}, La/h/d/a;->d(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6}, La/h/d/a;->b(Ljava/lang/Object;)V

    :cond_1
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:La/h/d/a;

    invoke-virtual {v7, v6, v3}, La/h/d/a;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:La/h/d/a;

    invoke-virtual {v1}, La/h/d/a;->i()Ljava/util/ArrayList;
...
.method public final V(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, La/i/s/x;->Z(Landroid/view/View;I)V
...
.method public final W(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, La/i/s/x;->a0(Landroid/view/View;I)V
...
.method public final X(La/i/s/f0;)La/i/s/f0;
    .locals 3

    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;
    ...
    iput-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;
    ...
    invoke-virtual {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e(La/i/s/f0;)La/i/s/f0;
...
.method public final Y()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->y:La/i/s/r;
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->y:La/i/s/r;

    :cond_1
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->y:La/i/s/r;

    invoke-static {p0, v0}, La/i/s/x;->A0(Landroid/view/View;La/i/s/r;)V
...
.method public final e(La/i/s/f0;)La/i/s/f0;
    .locals 4

    invoke-virtual {p1}, La/i/s/f0;->o()Z
    ...
    invoke-static {v2}, La/i/s/x;->z(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->f(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;La/i/s/f0;)La/i/s/f0;
...
.method public f(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, La/h/d/a;->g(Ljava/lang/Object;)Ljava/util/List;
...
.method public final getLastWindowInsets()La/i/s/f0;
    .locals 1
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:La/i/s/q;

    invoke-virtual {v0}, La/i/s/q;->a()I
...
.method public m(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, La/i/s/q;->c(Landroid/view/View;Landroid/view/View;II)V
...
.method public n(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, La/i/s/q;->d(Landroid/view/View;I)V
...
.method public onAttachedToWindow()V
    ...
    invoke-virtual {p0, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method public onMeasure(II)V
    ...
    iget-object v3, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;

    if-eqz v3, :cond_1

    invoke-static/range {p0 .. p0}, La/i/s/x;->z(Landroid/view/View;)Z
    ...
    invoke-static {v11, v10}, La/i/s/f;->b(II)I
    ...
    invoke-static/range {v20 .. v20}, La/i/s/x;->z(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;

    invoke-virtual {v0}, La/i/s/f0;->j()I

    move-result v0

    iget-object v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;
    ...
    iget-object v11, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:La/i/s/f0;

    invoke-virtual {v11}, La/i/s/f0;->i()I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_5
    invoke-virtual {v0, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-virtual {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->R(Z)V
...
.method public s(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, La/h/d/a;->h(Ljava/lang/Object;)Ljava/util/List;
...
.method public setStatusBarBackgroundResource(I)V
    ...
    invoke-static {v0, p1}, La/i/i/b;->f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public u(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, La/h/d/b;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public v(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v1 .. v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->w(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
...
.method public final w(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    .locals 5
    ...
    invoke-static {p1, p2}, La/i/s/f;->b(II)I
    ...
    invoke-static {p5, p2}, La/i/s/f;->b(II)I
