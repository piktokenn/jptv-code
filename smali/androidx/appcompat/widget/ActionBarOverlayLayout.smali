...
.field public w:La/i/s/f0;

.field public x:La/i/s/f0;

.field public y:La/i/s/f0;

.field public z:La/i/s/f0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, La/i/s/f0;->a:La/i/s/f0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:La/i/s/f0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:La/i/s/f0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:La/i/s/f0;
    ...
    new-instance p1, La/i/s/q;

    invoke-direct {p1, p0}, La/i/s/q;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->G:La/i/s/q;
...
.method public a(Landroid/view/Menu;La/b/p/j/m$a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->g:La/b/q/a0;

    invoke-interface {v0, p1, p2}, La/b/q/a0;->a(Landroid/view/Menu;La/b/p/j/m$a;)V
...
.method public c()V
    ...
    invoke-interface {v0}, La/b/q/a0;->c()V
...
.method public d()Z
    ...
    invoke-interface {v0}, La/b/q/a0;->d()Z
...
.method public e()Z
    ...
    invoke-interface {v0}, La/b/q/a0;->e()Z
...
.method public fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1, v1}, La/b/q/a1;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->G:La/i/s/q;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, La/b/q/a0;->getTitle()Ljava/lang/CharSequence;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->g:La/b/q/a0;

    invoke-interface {p1}, La/b/q/a0;->y()V
    ...
    invoke-interface {p1}, La/b/q/a0;->x()V
...
.method public i()V
    ...
    invoke-interface {v0}, La/b/q/a0;->h()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, p1, v1}, La/i/s/x;->g(Landroid/view/View;La/i/s/f0;Landroid/graphics/Rect;)La/i/s/f0;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, La/i/s/f0;->m(IIII)La/i/s/f0;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:La/i/s/f0;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:La/i/s/f0;

    invoke-virtual {v2, v1}, La/i/s/f0;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:La/i/s/f0;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:La/i/s/f0;
    ...
    :cond_2
    invoke-virtual {p1}, La/i/s/f0;->a()La/i/s/f0;

    move-result-object p1

    invoke-virtual {p1}, La/i/s/f0;->c()La/i/s/f0;

    move-result-object p1

    invoke-virtual {p1}, La/i/s/f0;->b()La/i/s/f0;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, La/i/s/x;->N(Landroid/view/View;)I
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:La/i/s/f0;

    iput-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    invoke-virtual {v0, v2, v1, v2, v2}, La/i/s/f0;->m(IIII)La/i/s/f0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    invoke-virtual {v3}, La/i/s/f0;->l()I

    move-result v3

    add-int/2addr v3, v1

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    invoke-virtual {v1}, La/i/s/f0;->k()I

    move-result v1

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    invoke-virtual {v4}, La/i/s/f0;->i()I

    move-result v4

    add-int/2addr v4, v2

    invoke-static {v0, v3, v1, v4}, La/i/j/b;->b(IIII)La/i/j/b;

    move-result-object v0

    new-instance v1, La/i/s/f0$b;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    invoke-direct {v1, v2}, La/i/s/f0$b;-><init>(La/i/s/f0;)V

    invoke-virtual {v1, v0}, La/i/s/f0$b;->c(La/i/j/b;)La/i/s/f0$b;
    ...
    :goto_3
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:La/i/s/f0;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:La/i/s/f0;

    invoke-virtual {v0, v1}, La/i/s/f0;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:La/i/s/f0;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v1, v0}, La/i/s/x;->h(Landroid/view/View;La/i/s/f0;)La/i/s/f0;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, La/i/s/q;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, La/b/q/a0;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, La/b/q/a0;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, La/b/q/a0;->n(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, La/b/q/a0;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method public final t(Landroid/view/View;)La/b/q/a0;
    .locals 3
...
.method public z()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t(Landroid/view/View;)La/b/q/a0;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->g:La/b/q/a0;
